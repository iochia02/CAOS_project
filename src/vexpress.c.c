...
// NOTE: THIS IS THE FILE FROM WHICH THE SITE http://souktha.github.io/software/qemu-port/ TALKS ABOUT
...
#include "qemu/datadir.h" // qemu_find_file:
#include "hw/sysbus.h" // Devices attached directly to the main system bus.
#include "hw/arm/boot.h" // ARM kernel loader.
#include "hw/arm/primecell.h"//  Declarations for ARM PrimeCell based periperals. + spme devices used in ARM
#include "hw/net/lan9118.h" // SMSC LAN9118 Ethernet interface emulation
#include "hw/i2c/i2c.h" // The QEMU I2C implementation only supports simple transfers that complete immediately.
...
#include "hw/loader.h" // loads the image of the program
#include "hw/block/flash.h" // NOR flash devices
#include "sysemu/device_tree.h" //  * Header with function prototypes to help device tree manipulation using libfdt.
#include "qemu/error-report.h" // error reporting
#include <libfdt.h>
#include "hw/char/pl011.h" // The PL011 is an Advanced Microcontroller Bus Architecture (AMBA) compliant System-on-Chip (SoC)
#include "hw/cpu/a9mpcore.h" // cortex a9 emulation
#include "hw/cpu/a15mpcore.h" // cortex a15 emulation
#include "hw/i2c/arm_sbcon_i2c.h" // ARM Versatile I2C controller
#include "hw/sd/sd.h" // SD Memory Card emulation.
#include "qapi/qmp/qlist.h" // QList Module (provides dynamic arrays)
#include "qom/object.h" // QEMU Object Model
#include "audio/audio.h" // QEMU Audio subsystem header
#include "target/arm/cpu-qom.h" // QEMU ARM CPU QOM header
...
// Create the hwaddr structure that defines my platform need to be created to match the phyiscal addresses of the memory and peripheral devices.
