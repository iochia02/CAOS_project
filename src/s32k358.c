...
struct S32K3MachineState {
    MachineState parent;
    ARMv7MState armv7m; // our CPU
};

struct S32K3MachineClass {
    MachineClass parent;
};

#define TYPE_S32K3_BASE_MACHINE MACHINE_TYPE_NAME("s32K3-base")
#define TYPE_S32K3_MACHINE MACHINE_TYPE_NAME("s32K3")

OBJECT_DECLARE_TYPE(S32K3MachineState, S32K3MachineClass, S32K3_MACHINE)

static void S32K3_init(MachineState *machine)
{
    S32K3MachineState *mms = S32K3_MACHINE_MACHINE(machine);
    S32K3MachineState *mmc = S32K3_MACHINE_GET_CLASS(machine);
